...
* The original package name 'com.example.shoppingcart.ProfileService-Management' is invalid and this project uses 'com.example.shoppingcart.ProfileServiceManagement' instead.
