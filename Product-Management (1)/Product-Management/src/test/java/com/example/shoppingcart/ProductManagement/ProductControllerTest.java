package com.example.shoppingcart.ProductManagement;
...
import com.example.shoppingcart.product.controller.ProductController;
...
import com.example.shoppingcart.product.models.ErrorResponse;
import com.example.shoppingcart.product.models.LoggerResponse;
...
class ProductControllerTest {
   ...
   @Test
   void addProductException()throws ProductAlreadyExistsException
   {
	   Product product=new Product(2,"Story","Forest","Book","4.5","good","",900.00,"","");
	   when(productRepository.save(product)).thenReturn(product);
	...
	@Test
	void updateProductException_test() {
		...
		assertThrows(ProductNotFoundException.class,()->{
			...
			productService.updateProducts(11, p3);
		});
	...
	@Test()
	void getProductByCategoryException_test() {
	...
	public void getProductByName_test() {
		...
		assertEquals(byname, productService.getProductByName("Hello"));
	...
	public void getProductByNameException_test() {
		...
		List<Product> byname = List.of(p6);
		when(productRepository.findByProductName("Hello")).thenReturn(byname);
		//assertEquals(byname, productService.getProductByName("Hi"));
		assertThrows(ProductNotFoundException.class,()->{
	...
	@Test
	public void deleteProductByIdException_test() {
		Product p6 = new Product();
		p6.setProductId(10);
		p6.setProductName("Hello");
		p6.setProductType("Cloth");
