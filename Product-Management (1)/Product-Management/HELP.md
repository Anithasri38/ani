...
* The original package name 'com.example.shoppingcart.Product-Management' is invalid and this project uses 'com.example.shoppingcart.ProductManagement' instead.
